package JDBC.Spring_JDBC.jdbcJava;


import JDBC.Spring_JDBC.student.Student;
...
public class JDBCOperator {
    ...
    private static void insertData() {
        BeanFactory factory = new ClassPathXmlApplicationContext("JDBC/Spring_JDBC/jdbc_configure/JDBC_Configure.xml");
    ...
    private static void selectData() {
        ...
        Student student1 = template.queryForObject("select * from student where id = 2", mapper);
